      ...
      describe("#triangle", function(){
        it("should draw simple triangle ", function(){
          ...
          expect(result).to.deep.equal(
            {
          "angles": [ 53.13010235415598,90,36.86989764584402 ],
          "arcs": "  [1,0,0.2,0.60,0.80] ,[3,1,0.2,2,0] ,[2.40,3.20,0.2,3,3]",
          "area": 6,
          "atxt": "[1.10,0.30,\"53.1\"],[1.50,0.50,\"90.0\"],[1.90,1.70,\"36.9\"]",
          "center": {
            "x": 1.5,
            "y": 2
          },
        ...
        it("should draw just one line triangle ", function(){
