...
--
-- Name: quiz_history; Type: TABLE; Schema: public; Owner: admin; Tablespace: 
--
...
ALTER TABLE public.quiz_history OWNER TO admin;

--
-- Name: quiz_history_id_seq; Type: SEQUENCE; Schema: public; Owner: admin
--

CREATE SEQUENCE quiz_history_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.quiz_history_id_seq OWNER TO admin;

--
-- Name: quiz_history_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: admin
--

ALTER SEQUENCE quiz_history_id_seq OWNED BY quiz_history.id;
...
ALTER TABLE ONLY enrol ALTER COLUMN id SET DEFAULT nextval('enrol_id_seq'::regclass);
...
ALTER TABLE ONLY question_container ALTER COLUMN id SET DEFAULT nextval('question_container_id_seq'::regclass);
...
ALTER TABLE ONLY quiz_container ALTER COLUMN id SET DEFAULT nextval('quiz_container_id_seq'::regclass);
...
ALTER TABLE ONLY quiz_history ALTER COLUMN id SET DEFAULT nextval('quiz_history_id_seq'::regclass);
...
ALTER TABLE ONLY quiz_tag ALTER COLUMN id SET DEFAULT nextval('quiz_tag_id_seq'::regclass);
...
ALTER TABLE ONLY quiz_useranswer ALTER COLUMN id SET DEFAULT nextval('quiz_useranswer_id_seq'::regclass);
...
ALTER TABLE ONLY starb ALTER COLUMN id SET DEFAULT nextval('starb_id_seq'::regclass);
...
ALTER TABLE ONLY starbkey ALTER COLUMN id SET DEFAULT nextval('starbkey_id_seq'::regclass);
...
ALTER TABLE ONLY tickets_trace ALTER COLUMN id SET DEFAULT nextval('tickets_trace_id_seq'::regclass);
...
ALTER TABLE ONLY weekplan ALTER COLUMN id SET DEFAULT nextval('weekplan_id_seq'::regclass);
...
--
-- Name: quiz_history_pkey; Type: CONSTRAINT; Schema: public; Owner: admin; Tablespace: 
--

ALTER TABLE ONLY quiz_history
...
--
-- Name: question_status; Type: INDEX; Schema: public; Owner: admin; Tablespace: 
--

CREATE INDEX question_status ON quiz_question USING btree (status);
...
--
-- Name: quiz_history_uc; Type: INDEX; Schema: public; Owner: admin; Tablespace: 
--

CREATE INDEX quiz_history_uc ON quiz_history USING btree (userid, container);
...
--
-- Name: quiz_history_container_fkey; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY quiz_history
    ADD CONSTRAINT quiz_history_container_fkey FOREIGN KEY (container) REFERENCES quiz_question(id) ON DELETE CASCADE;


--
-- Name: quiz_history_userid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY quiz_history
    ADD CONSTRAINT quiz_history_userid_fkey FOREIGN KEY (userid) REFERENCES users(id) ON DELETE CASCADE;
